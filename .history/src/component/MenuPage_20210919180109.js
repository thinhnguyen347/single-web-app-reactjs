    ...
    <div className="col col-md-6 col-lg-3 col-lg-2 p-1 p-md-2 p-lg-4 text-decoration-none text-dark">
      <div className="card h-100">
        ...
        <div className="card-body d-flex flex-column">
          ...
          <p className="btn btn-warning w-100 fw-bold mt-3 my-0" onClick={addToList}>
            Thêm vào giỏ hàng
          </p>
        </div>
      </div>
          ...
          <div className="container pt-4 pt-lg-3">
            <nav aria-label="Page navigation example">
              <ul className="pagination d-flex justify-content-center">
                ...
                <li className="page-item">
                  <p className={`btn page-link text-dark ${currentPage===1 && "bg-secondary text-white"}`} onClick={()=> setCurrentPage(1)}>1</p>
                </li>
                <li className="page-item">
                  <p className={`btn page-link text-dark ${currentPage===2 && "bg-secondary text-white"}`} onClick={()=> setCurrentPage(2)}>2</p>
                </li>
                <li className="page-item">
                  <p className={`btn page-link text-dark ${currentPage===3 && "bg-secondary text-white"}`} onClick={()=> setCurrentPage(3)}>3</p>
                </li>
                <li className="page-item">
