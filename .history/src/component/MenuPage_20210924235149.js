...
export default function MenuPage() {
  ...
  let timer = useRef(),addedItems = useRef([]), searchResult= useRef([]);
              ...
              <ul className="pagination d-flex justify-content-center">
                ...
                <li className="page-item">
                  <button
                    ...
                    onClick={() => {
                      setCurrentPage(1);
                      if (list.length < 4) setProducts(searchResult.current);
                      if (list.length > 4) setProducts(searchResult.current.slice(0, 4));
                    }}
                    disabled={currentPage === 1}
                  >
                    1
                ...
                <li className="page-item">
                  <button
                    className={`btn page-link text-dark ${
                      currentPage === 2 && "bg-secondary text-white"
                    } ${hidePageBtn < 2 && "d-none"}`}
                    onClick={() => {
                      setCurrentPage(2);
                      if (list.length < 8) setProducts(searchResult.current.slice(4));
                      if (list.length > 8) setProducts(searchResult.current.slice(4, 4));
                    }}
                    disabled={currentPage === 2}
                  >
                    2
                ...
                <li className="page-item">
                  <button
                    className={`btn page-link text-dark ${
                      currentPage === 3 && "bg-secondary text-white"
                    } ${hidePageBtn < 3 && "d-none"}`}
                    onClick={() => {
                      setCurrentPage(3);
                      if (list.length < 12) setProducts(searchResult.current.slice(8));
                    }}
                    disabled={currentPage === 3}
                  >
                    3
                ...
                <li className="page-item">
                  <button
                    className="btn page-link text-dark"
                    aria-label="Next"
                    disabled={currentPage === 3|| hidePageBtn<3}
                    onClick={() => {
                      if (0 < currentPage < 3) {
                        setCurrentPage((currentPage) => currentPage + 1);
                        setIsLoading(true);
