import contact_img from "./img/contact.webp"
    ...
    <div class="container">
      <div class="row row-cols-lg-2">
        <div class="col-12 col-md-12 col-lg-4 col-xl-6 px-lg-5 pt-4">
          ...
          <img
            class="img-fluid d-block pt-4"
            src="./img/bg/contact.webp"
            alt="contact"
          />
        </div>
            ...
            <form class="form-card">
              <div class="row justify-content-between text-left">
                <div class="form-group col-sm-2 flex-column d-flex pt-2">
                  <label
                    class="form-control-label font-condense"
                    for="guest-title"
                  >
                    Title
                  </label>
                ...
                <div class="form-group col-sm-10 flex-column d-flex pt-2">
                  <label class="form-control-label font-condense">
                    Your name<span class="text-info"> *</span>
                  </label>
                  <input
                    type="text"
                    id="fname"
              ...
              <div class="row justify-content-center">
                <p class="btn rounded-pill text-center my-4 book-now">SEND</p>
              </div>
            </form>
          </div>
        </div>
