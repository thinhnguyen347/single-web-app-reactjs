...
export default function MenuPage() {
  ...
  <ul className="pagination">
    <li className="page-item">
      <p className="page- " aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </p>
    </li>
    <li className="page-item"><p className="page- ">1</p></li>
    <li className="page-item"><p className="page- ">2</p></li>
    <li className="page-item"><p className="page- ">3</p></li>
    <li className="page-item">
      <p className="page- " aria-label="Next">
