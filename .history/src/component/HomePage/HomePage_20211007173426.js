...
export default function HomePage() {
  ...
  return (
    <>
      <iframe title="yummy" className="w-100" height="550px" src="https://www.youtube-nocookie.com/embed/sPuCC--Tu4E?autoplay=1&cc_load_policy=1&vq=tiny" frameborder="0"></iframe>
