        ...
        {combo.map(({ id, img }) => (
          <div key={id} className="col-12 col-md-6 col-lg-4">
            <div className="container px-0 border rounded overflow-hidden position-relative">
              ...
              <div className="tag py-3 bg-danger rounded-circle position-absolute start-0 bottom-0">
                <div className="text-light d-flex flex-column align-content-center justify-content-center">
                  <p className="btn m-0">MUA NGAY!</p>
