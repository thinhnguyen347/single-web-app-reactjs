...
function MainContent({
  ...
  return (
    <div className="col col-md-6 col-lg-3 col-lg-2 p-1 p-md-2 p-lg-3 text-decoration-none text-dark">
      ...
      <Link to={`/menu/${slug}`}><div className="container-fluid position-relative">
        
          <img src={img} className="card-img-top" alt="yummy-food" />
        
        <p className="position-absolute btn top-50 start-50 translate-middle p-2 rounded-pill text-light bg-dark">Xem chi tiết</p>
        </div>
