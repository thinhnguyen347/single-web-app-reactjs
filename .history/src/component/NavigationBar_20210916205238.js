            ...
            <div className="position-relative">
              <div className="d-flex">
                <input
                  ...
                  onKeyUp={getValue}
                />
                <button className="btn btn-outline-success" onClick={getValue}>Tìm</button>
              </div>
              {(fetchComplete && searchResult.length > 0) ? (
                <div className="result-modal container position-absolute top-100 start-0 bg-light rounded">
                  <span className="text-center fw-light fst-italic"> Có {searchResult.length} kết quả</span>
