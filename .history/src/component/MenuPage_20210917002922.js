...
export default function MenuPage() {
  ...
  function sort(e) {
    ...
    if (status==="1") list.sort((a,b)=> {return (a.price-b.price)})
      ...
      {isLoading ? (
        ...
        <section className="px-3 py-5 p-md-5">
          ...
          <div className="container-fluid pt-2">
            {products.length>0 ? <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 g-lg-2">
            ...
            </div> : <p className="text-center fw-bold py-4">Không có kết quả phù hợp!</p>}
          </div>
        </section>
      )}
