        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarContent">
            ...
            <div className="position-relative">
              ...
              <div className="row row-cols-2 pt-2 px2 rounded bg-light overflow-hidden position-absolute top-100 start-0">
                <div className="col-4 bg-warning mb-2">{input}</div>
                <div className="col-8 bg-info mb-2">Chi tiet</div>
                <div className="col-4 bg-dark mb-2">{input}</div>
                <div className="col-8 bg-info mb-2">Chi tiet</div>
              </div>
            </div>
          </div>
