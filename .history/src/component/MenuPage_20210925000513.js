...
export default function MenuPage() {
  ...
  const [endPageBtn, setHidePageBtn] = useState(0);
              ...
              <ul className="pagination d-flex justify-content-center">
                ...
                <li className="page-item">
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (list.length > 4)
                        list = searchResult.current.slice(0, 4);
                    }}
                    disabled={currentPage === 1}
                  >
                    1
                ...
                <li className="page-item">
                  <button
                    ...
                    onClick={() => {
                      setCurrentPage(2);
                      if (list.length < 8)
                        list = searchResult.current.slice(4);
                      if (list.length > 8)
                        list = searchResult.current.slice(4, 4);
                    }}
                    disabled={currentPage === 2}
                  >
                    2
                ...
                <li className="page-item">
                  <button
                    className="btn page-link text-dark"
                    aria-label="Next"
                    disabled={currentPage === 3 || currentPage - hidePageBtn === 0}
                    onClick={() => {
                      if (0 < currentPage < 3) {
                        setCurrentPage((currentPage) => currentPage + 1);
                        setIsLoading(true);
