...
export default function MenuPage() {
  ...
  useEffect(() => {
    fetch(`https://yummy-db.herokuapp.com/products?title_like=${input}?_page=${currentPage}&_limit=4`)
      .then((res) => res.json())
      .then((result) => {
        setProducts(result);
        setIsLoading(false);
  ...
  return (
    <>
      ...
      <div class="alert alert-primary position-fixed bottom-0 left-100" role="alert">
