  ...
  return (
    <div className="container py-5 my-5">
      <div className="row row-cols-lg-2">
        <div className="col-12 col-md-12 col-lg-5 col-xl-6 px-lg-5 pt-4 ">
          <h3 className="title text-center">LIÊN HỆ VỚI CHÚNG&nbspTÔI!</h3>

          <p className="pt-3"> Địa chỉ: Đường 123, Gia Lâm, Hà Nội </p>
          <p className="pb-3"> Hotline: 0984.018.891 </p>
        ...
        <div className="col-12 col-md-12 col-lg-7 col-xl-6 px-lg-5 pt-4 pt-md-1">
