        ...
        <div className="row g-4 d-flex align-items-center justify-content-center">
          ...
          <div className="col-12 col-sm-12 col-md-5 d-flex align-items-center justify-content-center">
            <input
              type="email"
              id="email"
              className="flex-fill rounded-start py-2 px-2 border-secondary border-1"
              value=""
              placeholder="Nhập email của bạn..."
              name="contact"
              aria-label="Email Address"
            />
            <button className="bg-success py-2 px-2 rounded-end border-1 border-success text-light">
              Đăng kí
            </button>
          </div>
        </div>
