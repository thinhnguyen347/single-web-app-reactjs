...
export default function Footer() {
  return (
    <>
      <div className="newsletter container-fluid pb-3">
        <div className="row g-3 ">
          ...
          <div className="col-12 col-sm-12 col-md-8 d-flex align-items-center justify-content-center">
            <input
              type="email"
              id="email"
              className="rounded-start py-1 px-2 border-secondary border-1"
              value=""
              placeholder="Nhập email của bạn"
              name="contact"
              aria-label="Email Address"
            />
            <button className="bg-success py-1 px-2 rounded-end border-1 border-success text-light">
              Đăng kí
            </button>
          </div>
        </div>
