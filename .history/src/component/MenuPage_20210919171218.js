          ...
          <div className="container">
            <nav aria-label="Page navigation example ">
              <ul className="pagination mx-auto">
                ...
                <li className="page-item">
                  <p className="btn page-link text-dark" onClick={()=> setcurrentPage(1)}>1</p>
                </li>
                <li className="page-item">
                  <p className="page-link text-dark" onClick={()=> setcurrentPage(2)}>2</p>
                </li>
                <li className="page-item">
                  <p className="page-link text-dark" onClick={()=> setcurrentPage(3)}>3</p>
                </li>
                <li className="page-item">
