...
export default function MenuPage() {
  ...
  <ul className="pagination">
    ...
    <li N="page-item"><a N="page-link" href="#">1</a></li>
    <li N="page-item"><a N="page-link" href="#">2</a></li>
    <li N="page-item"><a N="page-link" href="#">3</a></li>
    <li N="page-item">
      <a N="page-link" href="#" aria-label="Next">
