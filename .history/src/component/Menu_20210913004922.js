    ...
    <div className="card h-100">
      ...
      <div className="card-body d-flex flex-column">
        ...
        <div className="spinbox d-flex flex-row mx-auto">
          <div className="d-flex w-100 align-items-center justify-content-center border border-secondary rounded-start" onClick={(e) => {e.stopPropagation(); decrease(id,e)}}>
            <BiMinus />
          </div>
          <div
          ...
          <div className="d-flex w-100 align-items-center justify-content-center border border-secondary rounded-end" onClick={(e) => {e.stopPropagation(); increase(id,e)}}>
            <BiPlus />
          </div>
        </div>
