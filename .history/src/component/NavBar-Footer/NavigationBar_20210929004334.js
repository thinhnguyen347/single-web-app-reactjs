...
export default function NavBar() {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-light position-fixed top-0 start-0 w-100 px-1 px-md-5 py-md-4 border-3 border-bottom border-secondary position-relative">
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarContent">
            <ul className="on me-auto mb-2 mb-lg-0 ms-auto me-0">
            ...
            <Link
              ...
              onClick={hideModal}
            >
              <div className="position-relative me-4 me-lg-1">
                <span className="fs-4">
                <FiShoppingCart />
                </span>
                <span className="mt-2 position-absolute top-0 start-100 translate-middle badge bg-danger rounded-circle">
