...
export default function NavBar() {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-light position-fixed top-0 start-0 w px-1 px-md-5 py-md-4 border-3 border-bottom border-secondary position-relative">
