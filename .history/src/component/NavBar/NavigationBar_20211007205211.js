...
import { resetBackHome } from "../../app/backHomePageSlice";
...
export default function NavBar() {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-light position-sticky top-0 start-0 w-100 px-1 px-md-5 py-md-4 border-2 border-bottom border-secondary position-relative">
        <div className="container-fluid">
          ...
          <Link
            ...
            to="/shopping-cart"
          >
            <div className="position-relative me-3" onClick={() => dispatch(resetBackHome())}>
              <span className="fs-4">
                <FiShoppingCart />
              </span>
          ...
          <div className="collapse navbar-collapse" id="navbarContent">
            ...
            >
              <div
                className="position-relative me-4 me-lg-1"
                onClick={() => dispatch(resetBackHome())}
              >
                <span className="fs-4">
                  <FiShoppingCart />
                </span>
            ...
            <div className="position-relative">
              <div className="d-flex">
                ...
                />
                <button className="btn btn-success" onClick={getValue}>
                  Tìm
                </button>
              </div>
              ...
              {showResultModal && (
                <div
                  ...
                  onMouseLeave={() =>
                    (timer = setTimeout(autoHideResultModal, 2000))
                  }
