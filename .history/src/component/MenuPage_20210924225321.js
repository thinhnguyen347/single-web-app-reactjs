              ...
              <ul className="pagination d-flex justify-content-center">
                ...
                <li className="page-item">
                  <button
                    ...
                    onClick={() => {
                      setCurrentPage(1);
                      if (list.length < 4) setProducts(list);
                      if (list.length > 4) setProducts(list.slice(0,4));
                    }}
                    disabled={currentPage === 1}
                  >
                    1
                ...
                <li className="page-item">
                  <button
                    ...
                    onClick={() => {
                      setCurrentPage(2);
                      if (list.length < 8) setProducts(list.slice(4));
                      if (list.length > 8) setProducts(list.slice(4,4));
                    }}
                    disabled={currentPage === 2}
                  >
                    2
                ...
                <li className="page-item">
                  <button
                    ...
                    onClick={() => {
                      setCurrentPage(3);
                      if (list.length < 12) setProducts(list.slice(8));
                      if (list.length > 12) setProducts(list.slice(5,4));
                    }}
                    disabled={currentPage === 3}
                  >
                    3
