...
export default function MenuPage() {
  ...
  function addToList(id) {
    ...
    if (list[index].amount > 0) {
      ...
      timer.current = setTimeout(() => setAlertSuccess(false), 1500);
      setProducts(list);
    } else {
      setAlertFail(true);
      timer.current = setTimeout(() => setAlertFail(false), 1500);
    }
  }
  ...
  return (
    <>
      ...
      <section className="px-3 py-5 p-md-5">
        ...
        <div
          className={`alert alert-danger position-fixed bottom-0 end-0 mx-0 mx-md-5 ${alertFail && "opacity-100"}`}
          role="alert"
        >
        ...
        <div          
        className={`alert alert-danger position-fixed bottom-0 end-0 mx-0 mx-md-5 ${alertSuccess && "opacity-100"}`}
          role="alert"
        >
