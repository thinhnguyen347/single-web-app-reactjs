      ...
      <section className="px-3 py-5 p-md-5">
        ...
        <div className="container-fluid pt-4">
          <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 gx-lg-2 gy-2 justify-content-between">
            <div className="col col-md-6 col-lg-3 col-lg-2 p-1 p-md-2 px-lg-4 text-decoration-none text-dark align-self">
            ...
            <div className="col col-md-6 col-lg-3 col-lg-2 p-1 p-md-2 px-lg-4 ps-lg-0 text-decoration-none text-dark flex-row">
