      ...
      <section className="px-3 py-5 mb-5 p-md-3">
        ...
        {message ? (
          <p className="h6 text-center">
            Hiện có
            <span className="text-danger fw-bold mx-2">{addedList.length}</span>
              ...
              <div className="p-4 border rounded">
                ...
                <div className="mt-5 mb-3 d-flex flex-row flex-wrap justify-content-between align-items-center">
                  <p
                    ...
                    } text-start text-secondary mb-0`}
                  >
                    VAT (10%):
                  </p>
                ...
                <div className="mb-3 d-flex flex-row flex-wrap justify-content-between justify-content-md-center justify-content-lg-between align-items-center">
