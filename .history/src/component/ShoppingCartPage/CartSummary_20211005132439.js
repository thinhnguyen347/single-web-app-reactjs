  ...
  return (
    <div className="container-fluid p-0 mb-3">
      <div className="row row-cols-2 g-3">
        <div className="col-3 px-1 py-1 px-md-3">
        ...
        <div className="col-9 container-fluid position-relative">
          <div className="row row-cols-2 row-cols-md-1">
            ...
            <div className="col-6 col-md-3">
              ...
              <p className=" py-1 py-lg-2 text-center mb-0">
            ...
            <div className="col-6col-md-3">
              <p className="m-0 text-center">Thành tiền</p>
              <p className="py-1 py-lg-2 text-center fw-bold mb-0">
                <span className="price">
