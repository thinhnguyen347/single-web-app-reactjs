    ...
    <>
      <nav aria-label="breadcrumb" className="ms-4 ms-lg-5 py-3">
        <ol className="breadcrumb">
          ...
          <li className={`breadcrumb-item text-secondary ${!paymentOn && "text-primary active"}`}>
            Thông tin giao hàng
          </li>
          <li className={`breadcrumb-item text-secondary ${paymentOn && "text-primary active"}`}>Thanh toán</li>
        </ol>
      </nav>
