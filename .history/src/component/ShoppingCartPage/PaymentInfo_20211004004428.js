...
export default function PaymentInfo({ returnToGuestInfo }) {
  ...
  return (
    <div className="section">
      ...
      <div>
        <span className="fw-bold d-block p-2">Lựa chọn phương thức thanh toán</span>
        ...
        <p>Số tài khoản: <span className="fw-bold">0011 1100 1111 </span> tại ngân hàng Vietcom&nbsp;Bank</p>
        <p>Ví Momo: <span className="fw-bold">0984018891</span> - Chủ tài khoản: Nguyễn Đuwc Thịnh</p>
