      ...
      <div className="section-content section-customer-information">
        <div className="fieldset">
          ...
          <div className="d-flex w-100">
            ...
            <div className="field">
              <div className="field-input-wrapper d-flex">
                <label
                  className="field-label p-2 ms-2"
                ...
                <input
                  ...
                  autocapitalize="off"
                  spellcheck="false"
                  className=" p-2 ms-2 rounded flex-fill"
                  maxlength="15"
                  type="tel"
              ...
              >
                ...
                <div className="field pt-2">
                  <div className="field-input-wrapper field-input-wrapper-select">
                    ...
                    <select
                      className="field-input p-2 rounded border-dark"
