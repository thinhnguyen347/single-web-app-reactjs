            ...
            <div className="col-12 col-md-6 py-0">
              ...
              <div className="container-fluid mx-0 px-0 d-flex justify-content-between align-items-center">
                ...
                <input
                  ...
                  onChange={(e)=> e.target.value==="SALE10" ? setDiscount(0.1) : setDiscount(0)}
                />
              </div>
              <hr />
              ...
              <div className="container-fluid mx-0 px-0 d-flex justify-content-between">
                ...
                <span className={`d-block fw-bold ${discount>0 ? "text-danger": ""}`}>
                {`d-block fw-bold ${discount>0 ? "text-danger": ""}`}{totalDiscount.toLocaleString("vi-VN", {
                    style: "currency",
                    currency: "VND",
                  })}
                </span>
