    ...
    <div className="section">
      ...
      <div className="section-content section-customer-information no-mb">
        ...
        <p className="section-content-text">
          Bạn đã có tài khoản?
          <a href="/account/login?urlredirect=%2Fcheckouts%2F76b8c808ae7a4f9ead1d87352f42871c%3Fstep%3D1">
            Đăng nhập
          </a>
        </p>
        ...
        <div className="fieldset">
          <div className="field   ">
            <div className="field-input-wrapper">
              <label className="field-label" for="billing_address_full_name">
                Họ và tên
              </label>
              <input
          ...
          <div className="field  field-two-thirds  field-show-floating-label">
            <div className="field-input-wrapper">
              <label className="field-label" for="checkout_user_email">
                Email
              </label>
              <input
                placeholder="Email"
              ...
              >
                ...
                <div className="field field-show-floating-label  field-half ">
                  <div className="field-input-wrapper field-input-wrapper-select">
                    ...
                    >
                      ...
                      <option data-code="GL444" value="444">
                        Huyện Ayun Pa
                      </option>

                      <option data-code="GL442" value="442">
                        Huyện Chư Prông
                      </option>

                      <option data-code="GL437" value="437">
                        Huyện Chư Păh
                      </option>

                      <option data-code="GL746" value="746">
                        Huyện Chư Pưh
                      </option>

                      <option data-code="GL443" value="443">
                        Huyện Chư Sê
                      </option>

                      <option data-code="GL438" value="438">
                        Huyện Ia Grai
                      </option>

                      <option data-code="GL748" value="748">
                        Huyện Ia Pa
                      </option>

                      <option data-code="GL435" value="435">
                        Huyện KBang
                      </option>

                      <option data-code="GL445" value="445">
                        Huyện Krông Pa
                      </option>

                      <option data-code="GL440" value="440">
                        Huyện Kông Chro
                      </option>

                      <option data-code="GL436" value="436">
                        Huyện Mang Yang
                      </option>

                      <option data-code="GL747" value="747">
                        Huyện Phú Thiện
                      </option>

                      <option data-code="GL809" value="809">
                        Huyện Đắk Pơ
                      </option>

                      <option data-code="GL745" value="745">
                        Huyện Đắk Đoa
                      </option>

                      <option data-code="GL441" value="441">
                        Huyện Đức Cơ
                      </option>

                      <option data-code="GL434" value="434">
                        Thành phố Pleiku
                      </option>

                      <option data-code="GL439" value="439">
                        Thị xã An Khê
                      </option>
                    </select>
                  </div>
                ...
                >
                  <div className="field field-two-thirds">
                    <div className="field-input-wrapper">
                      <label className="field-label" for="billing_address_city">
                        Thành phố
                      </label>
                      <input
                  ...
                  <div className="field field-third">
                    <div className="field-input-wrapper">
                      <label className="field-label" for="billing_address_zip">
                        Mã bưu chính
                      </label>
                      <input
