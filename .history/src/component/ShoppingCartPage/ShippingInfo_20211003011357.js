          ...
          <div className="row g-4">
            <div className="col-12 col-md-5 py-0 ps-md-0 border-end border-dark">
              ...
              <div className="container-fluid mx-0 px-0 d-flex justify-content-between align-items-center">
                ...
                <input
                  id="code"
                  className="d-block p-2 flex-fill ms-5 rounded border-primary"
              ...
              <div className="container-fluid mx-0 px-0 d-flex justify-content-between">
                ...
                <span className="d-block">{totalAfterSale.toLocaleString("vi-VN", {
                    style: "currency",
                    currency: "VND",
                  })}</span>
              </div>
              ...
              <div className="container-fluid mx-0 px-0 d-flex justify-content-between">
                ...
                <span className="d-block">{final_price.toLocaleString("vi-VN", {
                    style: "currency",
                    currency: "VND",
                  })}</span>
              </div>
