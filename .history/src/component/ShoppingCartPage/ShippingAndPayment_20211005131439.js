        ...
        <div className="container pt-3 pt-md-4">
          <div className="row g-5">
            ...
            <div className="col-12 col-lg-6 py-0">
              ...
              <hr />
              <div className="container-fluid mx-0 px-0 d-flex align-items-center">
                <label htmlFor="code" className="d-block col-12 col-6">
                  Mã giảm giá (SALE10, SALE15):
                </label>
                <input
                  id="code"
                  maxLength="10"
                  className="d-block p-2 rounded text-center col-12 col-6"
