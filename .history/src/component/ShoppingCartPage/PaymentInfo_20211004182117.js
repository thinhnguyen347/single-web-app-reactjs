      ...
      <div>
        ...
        <label className="py-3 d-block" htmlFor="homeDelivery">
          <input
            ...
            className="me-3"
            defaultChecked
            onClick={(e)=>{if(e.target.checked) setOnlinePayment(false)}}
          />
        ...
        {onlinePayment && <div className="border border-success rounded p-2 mt-3">
          <p>
          ...
          <p className="fw-bold">
          Chủ tài khoản: <span >0984018891</span> -  Nguyễn Đức Thịnh
          </p>
        </div>}
      </div>
