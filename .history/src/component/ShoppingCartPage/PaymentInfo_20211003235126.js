export default function PaymentInfo({ returnToShippingInfo }) {
  return (
              ...
              >
                ...
                <div className="container-fluid mx-0 px-0 d-flex justify-content-between">
                  <button
                    ...
                    onClick={() => returnToShippingInfo()}
                  >
                    Quay lại giỏ hàng
                  </button>
                  <button type="submit" className="btn btn-primary mt-4 me-0 d-block" onClick={(e)=>e.preventDefault()}>
