    ...
    <div className="container py-5 my-5">
      <div className="row row-cols-lg-2">
        <div className="col-12 col-md-12 col-lg-6 col-xl-6 px-lg-5 pt-4 ">
          ...
          <p className="pt-3 mb- text-center">Khi quý khách có nhu cầu đặt với số lượng lớn để hưởng ưu đãi giá tốt&nbsp;nhất</p>
          <p className="pt-3 text-center"> Địa chỉ: Đường 123, Gia Lâm, Hà&nbsp;Nội </p>
          <p className="pb-3 text-center"> Hotline/ Zalo: 0984.018.891 </p>
