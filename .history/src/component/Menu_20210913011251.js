    ...
    <div className="card h-100">
      ...
      <div className="card-body d-flex flex-column">
        ...
        <div className="spinbox d-flex flex-row mx-auto">
          ...
          <div
            className="d-flex w-100={(e) => e.nativeEvent.stopImmedi align-items-center justify-content-center border-top border-bottom border-secondary"
            onClickatePropagation()}
          >
