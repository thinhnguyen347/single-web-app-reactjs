  ...
  return (
    <div className="container py-5 my-5">
      <div className="row row-cols-lg-2">
        <div className="col-12 col-md-12 col-lg-4 col-xl-6 px-lg-5 pt-4 pt-md-1">
            ...
            <form className="form-card">
              <div className="row justify-content-between text-left">
                <div className="form-group col flex-column d-flex pt-2">
                  <label className="form-control-label font-condense" htmlFor="fname">
                    Tên khách hàng<span className="text-info"> *</span>
                  </label>
                  <input
                    type="text"
                    id="fname"
              ...
              <div className="row justify-content-between text-left pt-2">
                <div className="form-group col-12 flex-column d-flex">
                  ...
                  <textarea id="comment" name="comment" className="p-2 fst-italic" defaultValue=""></textarea>
                </div>
              </div>
