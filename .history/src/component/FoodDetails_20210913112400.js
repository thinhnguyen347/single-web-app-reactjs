    ...
    <div className="container">
      <div className="row row-cols-1 row-cols-md-2 g-3">
        ...
        <h3 className="fw-bold">Tên món</h3>
          <ul>
            <li>
            <h5 className="fw-bold">Nguyên liệu:</h5></li>
            <p>
              ...
              Occaecat incididunt nostrud velit veniam deserunt deserunt ut
              culpa aliquip cillum id. Ullamco esse cillum ullamco adipisicing
              nulla laboris proident. Cillum pariatur non consequat elit labore
              aute aute laboris sit consectetur exercitation id mollit.
            </p>
            <li><h5 className="fw-bold">Nhà cung cấp:</h5><li>
            <ul>
