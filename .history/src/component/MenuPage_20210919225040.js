...
export default function MenuPage() {
  ...
  useEffect(() => {
    fetch(
      `https://yummy-db.herokuapp.com/products?title_like=${keyword}`
    )
      .then((res) => res.json())
      .then((result) => {
        setProducts(result);
        ...
        <section className="px-3 py-5 p-md-5">
          ...
          <div className="container-fluid pt-4">
            <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 gx-lg-2 gy-2 justify-content-between">
              <div className="col col-md-6 col-lg-3 col-lg-2 p-1 p-md-2 px-lg-4 text-decoration-none text-dark position-relative">
                <div className="d-flex ">
                  ...
                  <span className="my-0 position-absolute top-50 end-50 translate-middle">Reset</span>
                </div>
              </div>
          ...
          {isSearching && <div className="container pt-4 pt-lg-3">
            <nav aria-label="Page navigation example">
              <ul className="pagination d-flex justify-content-center">
                <li className="page-item">
                  <button className="btn page-link text-dark" aria-label="Previous" disabled={currentPage === 1}>
                ...
                <li className="page-item">
                  <button className="btn page-link text-dark" aria-label="Next" disabled={currentPage === 3}>
