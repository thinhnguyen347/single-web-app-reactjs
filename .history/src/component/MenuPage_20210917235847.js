...
function MainContent({
  ...
  return (
    <div className="col col-md-6 col-lg-3 col-lg-2 p-1 p-md-2 text-decoration-none text-dark">
      ...
      {isLoading ? (
        ...
        <section className="px-3 py-5 p-md-5">
          ...
          <div className="container-fluid pt-2">
            {list.length > 0 ? (
              <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 g-lg-">
