...
export default function MenuPage() {
  ...
  function addToList(id) {
    ...
    let cart_current = JSON.parse(localStorage.getItem("cart")); // localStorage.setItem("cart","[]")

    let index1 = cart_current.findIndex((item) => item.id === list[index].id); //index_Of_CartItem_In_AddedList
    if (index1 < 0) {
