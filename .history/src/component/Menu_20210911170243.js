  ...
  function MainContent({ img, title, price }) {
    return (
      <div className="col col-md-6 col-lg-3 col-lg-2 p-1 p-md-2 p-lg-3">
        <div className="card h-100 position-relative overflow-hđen">
            <p className="btn position-absolute p-2 p-md-1 bg-primary text-white border-radius-start top-0 end-100">Chi tiết</p>
