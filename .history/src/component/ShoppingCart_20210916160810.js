      ...
      <section className="px-3 py-5 mb-5 p-md-3">
        ...
        {message ? (
          <p className="h6 text-center">
            Hiện có
            <span className="text-danger fw-bold mx-2">{addedList.length}</span>sản
            phẩm trong giỏ hàng
          </p>
        ) : (
          <p></p>
          ...
          <div className="row g-4">
            ...
            <div className="col-12 col-md-4 pe-0">
              <div className="p-4 border rounded">
                ...
                <div className="d-flex flex-row flex-wrap justify-content-between justify-content-md-between justify-content-lg-between align-items-center">
