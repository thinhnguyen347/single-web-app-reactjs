...
export default function MenuPage() {
  ...
  const [isSearching, setIsSearching] = useState(fals);
  ...
  return (
    <>
          ...
          <div className="container pt-4 pt-lg-3">
            <nav aria-label="Page navigation example">
              <ul className="pagination d-flex justify-content-center">
                ...
                {(products.length /4 > 4) && <li className="page-item">
                  <p
                    className={`btn page-link text-dark ${
                ...
                {(products.length /4 > 8) && <li className="page-item">
                  <p
                    className={`btn page-link text-dark ${
      ...
      <div
        class="alert alert-primary position-fixed bottom-0 left-100"
        role="alert"
      >
