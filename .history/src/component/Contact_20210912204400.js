    ...
    <div className="container py-5 my-5">
      <div className="row row-cols-lg-2">
        <div className="col-12 col-md-12 col-lg-6 col-xl-6 px-lg-5 pt-4 ">
          <h3 className="title text-center text-primary">LIÊN HỆ VỚI CHÚNG&nbsp;TÔI!</h3>
            ...
            <form className="form-card">
              ...
              <div className="row justify-content-between text-left pt-2">
                <div className="form-group col-12 flex-column d-flex">
                  ...
                  <textarea id="comment" name="comment" className="p-2 fst-italic border border-secondary rounded" defaultValue="" required={true}></textarea>
                </div>
              </div>
