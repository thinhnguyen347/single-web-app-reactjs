  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-light px-1 px-md-5 py-md-4 border-3 border-bottom border-secondary position-relative">
        ...
        {/* {Mobile nav} */}
        <div className={`mobile-nav p-4 w-100 position-absolute top-0 ${showMobileMenu ? "start-0" : "start-100"}`} >
            
            <button className="btn btn-close d-block ms-auto me-0 my-4" onClick={toggleMobileMenu}></button>
