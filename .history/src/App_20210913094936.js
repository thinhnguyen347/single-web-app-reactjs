...
function NavBar() {
  return (
    <>
      <nav className="container-fluidnavbar navbar-expand-lg navbar-light bg-light px-1 px-md-5 py-md-4 border-3 border-bottom border-secondary">
...
function Footer() {
  return (
    <footer className="container-fluid d-flex flex-wrap justify-content-between align-items-center p-2 px-md-5">
      <a
